        ...
        <div className="flex flex-col space-y-10">
            ...
            <div>
                ...
                <div className="mx-auto w-[600px] h-[452px]  text-xl flex flex-col justify-center  ">
                        ...
                        <p className="mb-20">Are you tired of costly and time-consuming manual inspections that put your personnel at risk? Step into the future of industrial inspections with our cutting-edge drone technology. Our drone inspection solutions offer a game-changing approach to assessing assets, infrastructure, and facilities with unparalleled efficiency and safety.</p>
                    </div>
            ...
            <div>
                ...
                <div className="flex flex-col md:flex-row gap-4 m-4 justify-around">
                    ...
                    <div className="mx-auto w-[600px] h-[452px]  text-xl flex flex-col justify-center  ">
                        ...
                        <p className="mb-20">When it comes to <span className="text-red-600 font-bold">critical search and rescue</span>  missions, <span className="text-red-600 font-bold">every second counts! </span>
